...
import { Smartphone, Users, Layers, Unlink, ShieldAlert, ArrowDown, Heart, BookOpen, Lightbulb, Shield, Handshake, Gem, Fingerprint } from "lucide-react";
    ...
    <div className="min-h-screen bg-[#050505] text-white selection:bg-brand-orange/30 font-sans">
      ...
      <section className="relative pt-40 pb-24 px-6 overflow-hidden">
        ...
        >
          ...
          <motion.h1 variants={fadeInUp} className="text-5xl md:text-7xl font-medium tracking-tighter text-white mb-8 leading-[1.1]">
            Why We Are Here.
          </motion.h1>

          <motion.p variants={fadeInUp} className="text-xl md:text-2xl text-zinc-400 font-light max-w-3xl mx-auto mb-20 leading-relaxed">
            We live in an era of unprecedented connectivity, yet we have never felt more alone. 
            People today face a crisis of <span className="text-white font-normal">disconnection</span>.
          </motion.p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
             {problems.map((item, i) => (
               ...
               >
                 <div className={`w-12 h-12 rounded-full bg-zinc-800 flex items-center justify-center mb-6 ${item.color}`}>
                    <item.icon size={24} />
                 </div>
      ...
      <section className="relative py-32 px-6 overflow-hidden">
        ...
        >
           ...
           <motion.div variants={fadeInUp}>
              <span className="text-brand-orange font-bold uppercase tracking-[0.2em] text-sm mb-6 block">Our Mission</span>
              ...
              <p className="text-xl md:text-2xl text-zinc-300 font-light leading-relaxed border-l-2 border-brand-orange/30 pl-8">
                Providing access, mentorship, opportunities, and belonging that <span className="text-white font-normal">transcend time</span>.
              </p>
           </motion.div>

           {/* VISION SIDE */}
           <motion.div variants={fadeInUp} className="bg-[#0A0A0A] p-10 rounded-[2.5rem] border border-white/10">
              <span className="text-brand-yellow font-bold uppercase tracking-[0.2em] text-sm mb-6 block">Our Vision</span>
              <p className="text-lg text-zinc-400 leading-relaxed mb-8">
                To build a global, multi-generational community that sustains itself financially, socially, and culturally.
              </p>
              <div className="flex items-center gap-4">
                 <div className="h-[1px] flex-grow bg-white/10" />
                 <span className="text-white text-lg font-medium">Leaving a lasting impact.</span>
              </div>
           </motion.div>
      ...
      <section className="py-32 px-6">
         <div className="max-w-7xl mx-auto text-center">
            <h3 className="text-zinc-500 uppercase tracking-[0.3em] text-xs mb-16">The Inner Circle Solution</h3>
                 ...
                 { word: "Growth", desc: "Expanding horizons." }
                  ...
                  >
                    <h4 className="text-3xl lg:text-4xl xl:text-5xl font-medium text-transparent bg-clip-text bg-gradient-to-b from-white to-zinc-500 group-hover:to-white transition-all duration-500 w-full overflow-visible">
                      {item.word}<span className="text-brand-orange opacity-0 group-hover:opacity-100 transition-opacity duration-500">.</span>
                    </h4>
      ...
      <section className="pt-20 pb-40 px-6 bg-[#080808]">
         <div className="max-w-7xl mx-auto">
            <div className="text-center mb-20">
               <h2 className="text-4xl font-medium tracking-tight mb-4">Our Values</h2>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
               {values.map((val, i) => (
                  <motion.div 
                     ...
                     className={`p-8 rounded-[2rem] border border-white/5 bg-zinc-900/20 flex flex-col items-center text-center group ${val.wide ? 'md:col-span-2' : ''}`}
                  >
