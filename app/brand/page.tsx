...
export default function BrandPage() {
  return (
    <main className="min-h-screen bg-[#050505] text-white overflow-hidden selection:bg-brand-orange/30 font-sans">
      {/* --- HERO SECTION --- */}
      <section className="relative flex flex-col items-center justify-center text-center py-32 px-4 md:px-6 overflow-hidden min-h-[80vh]">
        ...
        >
          ...
          >
            The Inner Circle{" "}
            <span className="bg-clip-text px-3 text-transparent bg-gradient-to-r from-brand-orange via-brand-yellow to-brand-orange bg-[length:200%_auto] animate-gradient w-max px-2">
              Brand Identity
            </span>
          </motion.h1>
          ...
          <motion.p
            variants={fadeInUp}
            className="text-base sm:text-lg md:text-2xl text-zinc-400 font-light max-w-lg md:max-w-3xl mx-auto mb-12 md:mb-16 leading-relaxed tracking-wide text-balance"
          >
      ...
      <section className="max-w-7xl mx-auto px-4 md:px-6 pb-20 md:pb-32">
        <div className="mb-12 md:mb-16 text-center">
          <h2 className="text-3xl md:text-5xl font-medium mb-4 tracking-tighter">
            Brand Assets
          </h2>
          ...
          {brandAssets.map((asset, i) => (
            ...
            >
              <Link href={asset.path}>
                <div className="group relative p-8 md:p-12 rounded-[2rem] bg-[#0A0A0A] border border-white/5 hover:border-brand-orange/30 overflow-hidden transition-all duration-500 h-full flex flex-col">
                  {/* Background gradient */}
                  <div
                  ...
                  {/* Icon */}
                  <div className="relative z-10 w-16 h-16 md:w-20 md:h-20 rounded-2xl bg-white/5 flex items-center justify-center mb-6 text-brand-orange group-hover:bg-brand-orange/10 transition-colors duration-500">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {brandPrinciples.map((principle, i) => (
            <motion.div
              ...
              transition={{ delay: i * 0.1 }}
              viewport={{ once: true }}
              className="p-8 rounded-[2rem] bg-zinc-900/50 border border-white/5 hover:border-white/10 transition-all duration-300"
            >
