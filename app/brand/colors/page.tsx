    ...
    <div className="min-h-screen bg-[#050505] text-white selection:bg-brand-orange/30 font-sans pt-24 md:pt-32 pb-20 px-4 md:px-6">
      ...
      >
        ...
        <motion.h1 variants={fadeInUp} className="text-4xl md:text-7xl font-medium tracking-tighter mb-6 md:mb-8 leading-tight">
          Energy & <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-orange to-brand-yellow">Enlightenment.</span>
        </motion.h1>
        
        <motion.p variants={fadeInUp} className="text-lg md:text-xl text-zinc-400 font-light max-w-2xl mx-auto leading-relaxed">
          Our colors represent the journey of our members. From the grounding passion of orange 
          to the clarity and innovation of yellow.
        </motion.p>
      </motion.div>
      ...
      <section className="max-w-7xl mx-auto mb-24 md:mb-32">
         ...
         <div className="mt-6 md:mt-8 grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8">
            <div className="p-6 md:p-8 rounded-[2rem] bg-zinc-900/50 border border-white/5">
               <h3 className="text-brand-orange font-bold uppercase tracking-widest text-xs md:text-sm mb-3 md:mb-4">Meaning</h3>
               <p className="text-zinc-400 leading-relaxed text-sm md:text-base">
                 The deep orange symbolizes the grounding passion and raw potential of our members. 
                 It is the spark of connection and the warmth of community.
               </p>
            </div>
            <div className="p-6 md:p-8 rounded-[2rem] bg-zinc-900/50 border border-white/5">
               <h3 className="text-brand-yellow font-bold uppercase tracking-widest text-xs md:text-sm mb-3 md:mb-4">Meaning</h3>
               <p className="text-zinc-400 leading-relaxed text-sm md:text-base">
                 The transition to bright yellow signifies clarity, innovation, and "light bulb moments." 
                 It represents the dawn of a new generation of leaders.
               </p>
            </div>
         </div>
      </section>
    ...
    >
      ...
      <div className="p-6 md:p-8">
        ...
        <div className="space-y-2 md:space-y-3">
          ...
          >
            <span className="text-zinc-500 text-[10px] md:text-xs font-mono uppercase">HEX</span>
            <div className="flex items-center gap-2">
              <span className="text-white font-mono text-xs md:text-sm">{color.hex}</span>
              {copied === 'HEX' ? <Check size={14} className="text-green-500" /> : <Copy size={14} className="text-zinc-600 group-hover/btn:text-white" />}
            </div>
          </button>
          ...
          <button 
            ...
            className="w-full flex items-center justify-between p-3 rounded-xl bg-black border border-white/10 hover:bg-white/5 hover:border-white/30 transition-all group/btn active:scale-95"
          >
            <span className="text-zinc-500 text-[10px] md:text-xs font-mono uppercase">RGB</span>
            <div className="flex items-center gap-2">
              <span className="text-white font-mono text-xs md:text-sm">{color.rgb}</span>
              {copied === 'RGB' ? <Check size={14} className="text-green-500" /> : <Copy size={14} className="text-zinc-600 group-hover/btn:text-white" />}
            </div>
          </button>
          ...
          <button 
            ...
            className="w-full flex items-center justify-between p-3 rounded-xl bg-black border border-white/10 hover:bg-white/5 hover:border-white/30 transition-all group/btn active:scale-95"
          >
            <span className="text-zinc-500 text-[10px] md:text-xs font-mono uppercase">CMYK</span>
            <div className="flex items-center gap-2">
              <span className="text-white font-mono text-xs md:text-sm">{color.cmyk}</span>
              {copied === 'CMYK' ? <Check size={14} className="text-green-500" /> : <Copy size={14} className="text-zinc-600 group-hover/btn:text-white" />}
            </div>
          </button>
        </div>
      </div>
