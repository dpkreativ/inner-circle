    ...
    <div className="min-h-screen bg-background text-foreground selection:bg-brand-orange/30 font-sans">
      ...
      <section className="relative pt-28 md:pt-40 pb-16 md:pb-20 px-4 md:px-6 overflow-hidden">
        ...
        >
          <motion.div
            variants={fadeInUp}
            className="flex flex-col md:flex-row gap-6 md:gap-8 items-start md:items-end justify-between border-b border-border dark:border-white/10 pb-8 md:pb-12 mb-12 md:mb-20"
          >
            <div className="max-w-3xl">
              ...
              <h1 className="text-4xl md:text-8xl font-medium tracking-tighter leading-[0.95] text-foreground">
                The Radiant <br />
            ...
            <p className="text-muted-foreground dark:text-zinc-400 text-sm md:text-lg max-w-sm leading-relaxed pb-1 md:pb-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
            ...
            <motion.div
              variants={fadeInUp}
              whileHover={{ y: -5 }}
              className="group relative p-6 md:p-8 rounded-[2rem] bg-card dark:bg-zinc-900/40 backdrop-blur-md border border-border dark:border-white/5 hover:bg-muted/50 dark:hover:bg-zinc-900/80 transition-all duration-500 overflow-hidden"
            >
              ...
              <span className="text-3xl md:text-4xl font-bold text-muted-foreground/20 dark:text-white/10 mb-6 md:mb-8 block group-hover:text-brand-orange/20 transition-colors">
                01
              </span>
              <h3 className="text-xl md:text-2xl font-bold text-foreground dark:text-white mb-3">
                Unity in Diversity
              </h3>
              <p className="text-muted-foreground dark:text-zinc-400 leading-relaxed text-xs md:text-sm">
            ...
            >
              ...
              <span className="text-3xl md:text-4xl font-bold text-muted-foreground/20 dark:text-white/10 mb-6 md:mb-8 block group-hover:text-brand-yellow/20 transition-colors">
                02
              </span>
              <h3 className="text-xl md:text-2xl font-bold text-foreground dark:text-white mb-3">
                Energy & Growth
            ...
            >
              <div className="absolute top-0 right-0 p-6 md:p-8 opacity-20 group-hover:opacity-100 transition-opacity duration-500">
                <Type className="text-foreground dark:text-white w-8 h-8 md:w-10 md:h-10" />
              </div>
              <span className="text-3xl md:text-4xl font-bold text-muted-foreground/20 dark:text-white/10 mb-6 md:mb-8 block group-hover:text-foreground/20 dark:group-hover:text-white/20 transition-colors">
                03
              </span>
              <h3 className="text-xl md:text-2xl font-bold text-foreground dark:text-white mb-3">
                The Integrated &apos;C&apos;
      ...
      {/* --- QUICK RULES --- */}
      <section className="border-t border-border dark:border-white/10 bg-muted/30 dark:bg-zinc-950/50">
        <div className="max-w-7xl mx-auto px-6 py-16 md:py-20 flex flex-col md:flex-row justify-between items-start gap-8 md:gap-12">
          <div className="max-w-xs">
            <h3 className="text-xl font-bold mb-2 md:mb-4 text-foreground">
              Golden Rules
            </h3>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 md:gap-x-12 gap-y-4 md:gap-y-6 w-full md:w-auto">
            <div className="flex items-start gap-3 text-sm text-muted-foreground dark:text-zinc-300">
