...
import { ArrowRight, Users, Target, Layers, Globe, Sparkles, Zap, Mic, Crown, Sun, Anchor, MoveRight, ChevronLeft, ChevronRight } from "lucide-react";
...
export default function Home() {
  ...
  return (
    <div ref={containerRef} className="min-h-screen bg-[#050505] text-white overflow-hidden selection:bg-brand-orange/30 font-sans">
      ...
      <section className="relative h-screen flex flex-col items-center justify-center text-center px-4 md:px-6 overflow-hidden">
        ...
        >
          <motion.div variants={fadeInUp} className="flex items-center justify-center mb-6 md:mb-8">
          ...
          >
            Where <span className="font-light text-white/70">Stories</span>, <br className="hidden md:block" />
            <span className="bg-clip-text text-transparent bg-gradient-to-b from-white via-white to-white/50">Community</span>, & Purpose <br />
          ...
          <motion.p variants={fadeInUp} className="text-base sm:text-lg md:text-2xl text-zinc-400 font-light max-w-lg md:max-w-2xl mx-auto mb-8 md:mb-12 leading-relaxed tracking-wide text-balance">
            Building a global, multi-generational community that sustains itself 
            financially, socially, and culturally.
          </motion.p>

          <motion.div variants={fadeInUp} className="flex flex-col sm:flex-row gap-4 md:gap-5 justify-center items-center w-full px-4">
            <Link href="/logo" className="w-full sm:w-auto">
              <button className="group w-full sm:w-auto relative px-8 py-4 bg-white text-black rounded-full overflow-hidden hover:scale-105 transition-transform duration-300">
                <span className="relative z-10 flex items-center justify-center gap-3 text-sm font-bold tracking-wide uppercase">
                  Explore Assets <ArrowRight size={16} className="group-hover:translate-x-1 transition-transform" />
                </span>
            ...
            <Link href="/mission" className="w-full sm:w-auto">
               <button className="w-full sm:w-auto px-8 py-4 rounded-full border border-white/10 text-white hover:bg-white/5 hover:border-white/30 transition-all duration-300">
                  <span className="text-sm font-medium tracking-wide uppercase">Read the Mission</span>
               </button>
            </Link>
          </motion.div>
        </motion.div>
        ...
        <div className="flex overflow-hidden group">
          ...
          >
            {[...brandPillars, ...brandPillars].map((pillar, i) => (
               <div key={i} className="flex items-center gap-4 md:gap-6 text-xs md:text-base font-medium text-white/40 uppercase tracking-[0.15em] hover:text-white transition-colors cursor-default">
      ...
      <section className="py-20 md:py-32 relative group/carousel">
        <div className="max-w-7xl mx-auto px-6 mb-8 md:mb-12">
             <span className="text-brand-orange font-medium uppercase tracking-[0.2em] text-[10px] md:text-xs mb-3 block">Our Community</span>
             <h2 className="text-3xl md:text-6xl font-medium tracking-tighter text-white">Generational Tiers</h2>
        </div>
        ...
        <div className="relative">
            ...
            >
                ...
                >
                    <div className={`absolute inset-0 bg-gradient-to-b ${tier.gradient} opacity-10 group-hover:opacity-30 transition-opacity duration-700`} />
                    ...
                    <div className="relative z-10 h-full p-6 md:p-8 flex flex-col">
                        ...
                        <div className="mt-auto pt-6 border-t border-white/5">
                            <h3 className="text-2xl md:text-3xl font-medium mb-2 tracking-tight">{tier.name}</h3>
                            <p className="text-zinc-400 text-xs md:text-sm leading-relaxed font-light">{tier.desc}</p>
                        </div>
                    </div>
                </motion.div>
                ))}
      ...
      <section className="max-w-7xl mx-auto px-4 md:px-6 pb-20 md:pb-32">
        <div className="mb-16 md:mb-24 text-center max-w-3xl mx-auto">
             <h2 className="text-3xl md:text-6xl font-medium mb-6 tracking-tighter">Our Core Identity</h2>
             <p className="text-lg md:text-2xl text-zinc-400 font-light leading-normal">
                ...
                and legacy-building social impact engine.
             </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 auto-rows-auto md:auto-rows-[220px]">
           ...
           <div className="md:col-span-2 row-span-1 md:row-span-2 group relative p-8 rounded-[2rem] bg-[#0A0A0A] border border-white/5 hover:border-brand-orange/30 overflow-hidden transition-all duration-700 flex flex-col justify-between min-h-[300px]">
              <div className="absolute inset-0 opacity-20 group-hover:opacity-40 transition-opacity duration-700">
                ...
                <svg className="absolute top-0 left-0 w-full h-full pointer-events-none opacity-30">
                    <line x1="50%" y1="30%" x2="70%" y2="50%" stroke="#F97316" strokeWidth="0.5" />
                    <line x1="70%" y1="50%" x2="60%" y2="70%" stroke="#F97316" strokeWidth="0.5" />
                </svg>
              </div>
              <div className="relative z-10 mt-auto">
                  ...
                  <h3 className="text-2xl md:text-3xl font-medium text-white mb-3 tracking-tight">Community of Shared Growth</h3>
                  <p className="text-zinc-400 text-sm md:text-base leading-relaxed max-w-md font-light">
                     A space where connection transcends time, providing mentorship and opportunities across generations.
                  </p>
              </div>
           </div>
           ...
           <div className="group relative p-8 rounded-[2rem] bg-[#0A0A0A] border border-white/5 hover:border-brand-yellow/30 overflow-hidden transition-all duration-700 flex flex-col justify-between min-h-[200px]">
               ...
               <div className="relative z-10 mt-4">
                   <h3 className="text-xl font-medium text-white mb-2 tracking-tight">Storytelling Ecosystem</h3>
                   <p className="text-zinc-500 text-xs leading-relaxed">Where stories become lessons and content becomes legacy.</p>
               </div>
           </div>
           ...
           <div className="group relative p-8 rounded-[2rem] bg-[#0A0A0A] border border-white/5 hover:border-white/20 overflow-hidden transition-all duration-700 flex flex-col justify-between min-h-[200px]">
               ...
               <div className="relative z-10 mt-4">
                   <h3 className="text-xl font-medium text-white mb-2 tracking-tight">Impact Engine</h3>
                   <p className="text-zinc-500 text-xs leading-relaxed">Legacy-building initiatives driven by social impact.</p>
               </div>
           </div>
            ...
            <div className="md:col-span-3 group relative p-8 rounded-[2rem] bg-gradient-to-r from-[#0A0A0A] to-[#111] border border-white/5 hover:border-brand-orange/30 overflow-hidden flex flex-col md:flex-row items-center justify-between gap-8">
               ...
               <div className="flex-1 relative z-10">
                   <div className="flex items-center gap-3 mb-3">
                       ...
                       <span className="text-brand-orange font-bold uppercase text-[10px] tracking-[0.2em]">Global Vision</span>
                   </div>
                   <h3 className="text-2xl md:text-3xl font-medium text-white mb-3 tracking-tight">A Multi-Generational Movement</h3>
                   <p className="text-zinc-400 text-base md:text-lg max-w-2xl font-light">
                       To bridge generations, providing access, mentorship, and belonging that transcend time.
                   </p>
               </div>
           </div>
      ...
      <section className="max-w-7xl mx-auto px-4 md:px-6 pb-20 md:pb-40 pt-10">
        <div className="mb-10 md:mb-16 text-center border-t border-white/5 pt-10 md:pt-20">
             <span className="text-zinc-500 font-medium uppercase tracking-[0.2em] text-xs mb-4 block">The Brand in Motion</span>
             <h2 className="text-3xl md:text-6xl font-medium tracking-tighter text-white">Visual Identity</h2>
        </div>
  ...
  },
  {
    ...
    visual: (
        <div className="relative w-32 h-32 md:w-48 md:h-48 flex items-center justify-center">
            ...
            <svg width="100%" height="100%" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" className="drop-shadow-[0_0_15px_rgba(234,179,8,0.5)]">
                <motion.path 
