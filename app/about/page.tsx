        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8">
          {companies.map((company, i) => (
            <SpotlightCard key={i} delay={i * 0.1}>
              {/* LOGO PLATE */}
              <div className="relative w-full h-32 md:h-40 mb-6 md:mb-8 rounded-2xl md:rounded-3xl bg-zinc-900 flex items-center justify-center p-4 md:p-6 group-hover:scale-[1.02] transition-transform duration-500 shadow-lg border border-white/5">
              ...
              <div className="pt-6 md:pt-8 border-t border-border dark:border-white/5">
                <span className="text-[10px] md:text-xs font-bold uppercase text-muted-foreground dark:text-white/50 mb-3 block">
                  Focus Areas
                </span>
            ...
            <SpotlightCard key={i} delay={i * 0.1} className="h-full">
              <div className="flex flex-col h-full">
                ...
                <div className="flex justify-between items-start mb-6 md:mb-8">
                  <span
                    className={`px-2 py-1 md:px-3 md:py-1.5 rounded-full text-[9px] md:text-[10px] font-bold uppercase tracking-widest border ${
                      member.tag === "Co-Founder"
                        ...
                        : "bg-muted dark:bg-white/5 text-muted-foreground dark:text-zinc-400 border-border dark:border-white/10 group-hover:text-foreground dark:group-hover:text-white group-hover:border-foreground/20 dark:group-hover:border-white/20 transition-colors"
                    }`}
                  >
                    {member.tag}
                  </span>
                  <member.icon
                    size={18}
                    className="text-foreground dark:text-zinc-700 group-hover:text-brand-yellow transition-colors duration-300 md:w-5 md:h-5"
                  />
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 p-2 md:p-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {ambassadorDuties.map((duty, i) => (
                <div
                  key={i}
                  className="p-4 rounded-2xl bg-card/40 dark:bg-black/40 border border-border dark:border-white/5 hover:border-brand-orange/20 transition-colors"
                >
                  <duty.icon
                    size={18}
